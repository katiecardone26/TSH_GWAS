...
union_df <- union_df %>%
select(MarkerID, BETA_AOU, SE_AOU, BETA_ATLAS, SE_ATLAS, BETA_BIOME, SE_BIOME)
...
write.table(intersect_df, intersect_output_file, quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)