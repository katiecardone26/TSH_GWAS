...
#BSUB -J run_metasoft_5_inputs_no_adjustments[1-2]
...
java -jar metasoft/Metasoft.jar \
     -input input/${ANCESTRY_INDEX}.INV_NORMAL_TSH.5_inputs.metasoft_input.no_correction.union.txt \
     -pvalue_table metasoft/HanEskinPvalueTable.txt \
     -output output/${ANCESTRY_INDEX}.INV_NORMAL_TSH.5_inputs.no_correction.union.metasoft_output.no_mean_hetero_correction.txt \
     -log logs/${ANCESTRY_INDEX}.INV_NORMAL_TSH.5_inputs.no_correction.union.no_mean_hetero_correction.log
