...
#BSUB -J run_metasoft_no_adjustments_T4[1-2]
...
java -jar metasoft/Metasoft.jar \
     -input input/${ANCESTRY_INDEX}.FREE_T4.3_inputs.metasoft_input.no_correction.union.txt \
     -pvalue_table metasoft/HanEskinPvalueTable.txt \
     -output output/${ANCESTRY_INDEX}.FREE_T4.3_inputs.no_correction.union.metasoft_output.no_mean_hetero_correction.txt \
     -log logs/${ANCESTRY_INDEX}.FREE_T4.3_inputs.no_correction.union.no_mean_hetero_correction.log
