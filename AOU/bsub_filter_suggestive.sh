...
python filter_suggestive.py \
        --input AOU_v8_results/AoU_v8.TSH.${ANCESTRY_INDEX}.n=12385.GWAS_results.all_chr.INV_NORMAL_TSH.glm.linear.for_export \
        --input_type gwas \
        --pval_threshold 1e-5 \
        --output_prefix suggestive/AOU_v8.INV_NORMAL_TSH.${ANCESTRY_INDEX}.n=12385
