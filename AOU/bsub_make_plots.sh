...
SUMSTATS=(
    "AoU_v8.TSH.AFR.n=12385.GWAS_results.all_chr.INV_NORMAL_TSH.glm.linear.for_export"
    "AoU_v8.TSH.EUR.n=12385.GWAS_results.all_chr.INV_NORMAL_TSH.glm.linear.for_export"
)

PREFIX=(
    "AOU_v8.INV_NORMAL_TSH.AFR.n=12385"
    "AOU_v8.INV_NORMAL_TSH.EUR.n=12385"
)
...
python manhattan_plotting_script.py \
    ...
    --sumstats_input AOU_v8_results/${SUMSTATS_INDEX} \
    --title "${TITLE_INDEX}" \
    --subtitle "n = 12385" \
    --sumstats_chr_col '#CHROM' \
