...
# create par file
genotypename="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.bed"
snpname="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.bim"
indivname="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.fam"
outputformat="EIGENSTRAT"
genotypeoutname="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.eigenstratgeno"
snpoutname="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.snp"
indivoutname="output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.ind"

echo "genotypename:    $genotypename" > convertf.${OUTPUT_PREFIX_INDEX}.par
echo "snpname:         $snpname" >> convertf.${OUTPUT_PREFIX_INDEX}.par
echo "indivname:       $indivname" >> convertf.${OUTPUT_PREFIX_INDEX}.par
echo "outputformat:    $outputformat" >> convertf.${OUTPUT_PREFIX_INDEX}.par
echo "genotypeoutname: $genotypeoutname" >> convertf.${OUTPUT_PREFIX_INDEX}.par
echo "snpoutname:      $snpoutname" >> convertf.${OUTPUT_PREFIX_INDEX}.par
echo "indivoutname:    $indivoutname" >> convertf.${OUTPUT_PREFIX_INDEX}.par
...
# command
convertf -p convertf.${OUTPUT_PREFIX_INDEX}.par