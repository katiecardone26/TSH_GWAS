...
PHENO=(
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        ...
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.phenotype_covariates.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.phenotype_covariates.final.txt'
...
plink2 --glm hide-covar  cols=+a1freq \
        --bfile output/gwas_qc/${OUTPUT_PREFIX_INDEX}.gwas_qc.chr${CHR_INDEX} \
        --pheno input/${PHENO_INDEX} \
        --pheno-name INV_NORMAL_TSH \
        --covar input/${PHENO_INDEX} \
        --covar-name AGE_AGE SEX ${PC_INDEX} \
        --covar-variance-standardize AGE_AGE SEX ${PC_INDEX} \
        --adjust \
        --out output/gwas/${OUTPUT_PREFIX_INDEX}.gwas_qc.chr${CHR_INDEX}