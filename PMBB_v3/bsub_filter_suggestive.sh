...
python filter_suggestive.py \
        --input output/gwas/PMBB_v3.TSH.GWAS.${ANCESTRY_INDEX}.gwas_qc.all_chr.INV_NORMAL_TSH.glm.linear \
        --input_type gwas \
        --pval_threshold 1e-5 \
        --output_prefix output/suggestive/PMBB_v3.TSH.GWAS.${ANCESTRY_INDEX}.gwas_qc.all_chr.INV_NORMAL_TSH.glm.linear
