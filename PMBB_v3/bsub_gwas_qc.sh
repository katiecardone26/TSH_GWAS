...
SAMPLE_LIST=(
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        ...
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.EUR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.sample_list.final.txt'
        'PMBB_v3.TSH.GWAS.AFR.n=6937.sample_list.final.txt'
...
## merged output file
SAMPLE_LIST_INDEX=${SAMPLE_LIST[$INDEX]}
CHR_INDEX=${CHR[$INDEX]}
OUTPUT_PREFIX_INDEX=${OUTPUT_PREFIX[$INDEX]}

# command
plink2 --pfile input/merged_files/PMBB-Release-2024-3.0_genetic_imputed.chr${CHR_INDEX} \
        --keep input/${SAMPLE_LIST_INDEX} \
        --max-alleles 2 \
        --set-all-var-ids chr@:#:\$r:\$a \
        --exclude range input/longrange_LD_hg38.bed \
        --maf 0.01 \
        --geno 0.01 \
        --hwe 1E-6 \
        --snps-only \
        --make-bed \
        --out output/gwas_qc/${OUTPUT_PREFIX_INDEX}.gwas_qc.chr${CHR_INDEX}