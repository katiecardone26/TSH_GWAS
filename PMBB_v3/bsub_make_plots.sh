...
#   'min' is the first array indbjex
...
python manhattan_plotting_script.py \
    --annot_input output/vep_output/${PREFIX_INDEX}.vep_output.cleaned.txt \
    --sumstats_input output/gwas/${PREFIX_INDEX} \
    --title "${TITLE_INDEX}" \
    --subtitle "n = 6937" \
    --pval_col PVALUE_RE \
    ...
    --plot_sig True \
    --invert ${INVERT_INDEX} \
    --output_prefix output/plots/${PREFIX_INDEX}