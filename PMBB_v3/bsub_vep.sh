...
singularity exec --bind ./VEP_115_cache:/VEP_115_cache/,output/vcf:/vcf/,output/vep_output:/vep_output/ vep.sif \
    vep --dir /VEP_115_cache/ --cache --offline --format vcf \
        --force_overwrite \
        -i /vcf/${PREFIX_INDEX}.vcf \
        -o /vep_output/${PREFIX_INDEX}.vep_output.txt \
        --tab \
        --buffer_size 10000 \
        --cache_version 115 \
