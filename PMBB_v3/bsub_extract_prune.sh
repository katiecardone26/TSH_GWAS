...
plink2 --bfile output/freq_qc/${OUTPUT_PREFIX_INDEX}.freq_qc.all_chr \
        --extract output/ld_prune/${OUTPUT_PREFIX_INDEX}.ld_prune.all_chr.prune.in \
        --make-bed \
